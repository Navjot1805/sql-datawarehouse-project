...
This project demonstrates a comprehension data warehousing and analytics solution, from building a data warehouse to generating actionable insights.  
...
- **Scope**: Focus on latest dataset only; historical of data is not required.
